                ...
                <div className='md:w-1/2 flex justify-center items-center md:text-left text-center'>
                    <div className={`w-full ${poppins.className}`}>
                        ...
                        <div className='mt-6'>
                            ...
                            <button className='ml-4 mt-1 bg-transparent border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-full text-lg font-semibold hover:bg-blue-600 hover:text-white transition-all'>
                                Learn More
                            </button>
                        </div>
                    </div>
